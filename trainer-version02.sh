...
time R CMD BATCH --no-save --no-restore '--args input='wiki-en.txt' min_count=5 outputw='vectorsW.txt' outputc='vectorsC.txt' outputwc='vectorsB.txt' size=10 window=6 ' ./trainGloveModle.r trainGloveModle.out &
